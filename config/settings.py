...
SECRET_KEY = 'django-insecure-t@o3011%7@z+#%xy$kc3374thb172x*1yr0&e8#$&$gva2n+&u'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.core.context_processors.date_context',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'timeout': 30,  # 30 secondes au lieu de 5 secondes par défaut
        }
    }
}

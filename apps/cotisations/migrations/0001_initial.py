    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evenement_id', models.IntegerField(blank=True, help_text="ID de l'événement si cette cotisation est liée à un événement", null=True, verbose_name='ID Événement lié')),
                ('inscription_evenement_id', models.IntegerField(blank=True, help_text="ID de l'inscription à l'événement liée à cette cotisation", null=True, verbose_name='ID Inscription Événement')),
                ('type_cotisation', models.CharField(choices=[('adhesion', 'Adhésion'), ('cotisation', 'Cotisation'), ('evenement', 'Événement'), ('autre', 'Autre')], default='cotisation', max_length=20, verbose_name='Type de cotisation')),
        ...
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['statut'], name='cotisations_statut__38f4f6_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['type_membre'], name='cotisations_type_me_f506e8_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['bareme'], name='cotisations_bareme__6347a6_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['deleted_at'], name='cotisations_deleted_6b6b23_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['created_at'], name='cotisations_created_546571_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['updated_at'], name='cotisations_updated_3d6c03_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['date_emission'], name='cotisations_date_em_9e6c9e_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['type_cotisation'], name='cotisations_type_co_5bd6ef_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['deleted_at', 'statut_paiement'], name='cotisations_deleted_870aef_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['deleted_at', 'membre'], name='cotisations_deleted_a3356a_idx'),
        ),
        migrations.AddIndex(
            model_name='cotisation',
            index=models.Index(fields=['membre', 'statut_paiement'], name='cotisations_membre__5e419c_idx'),
        ),
        migrations.AddIndex(
